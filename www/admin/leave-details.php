...
{         
  ...
  <tr>
                                             <td style="font-size:16px;"><b>Approval Type :</b></td>
                                            <td><?php echo htmlentities($result->LeaveType);?></td>
                                             <td style="font-size:16px;"><b>Tanggal pengajuan konstruksi . :</b></td>
...
<tr>
                                             <td style="font-size:16px;"><b>Employee Description : </b></td>
