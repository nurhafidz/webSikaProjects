...
<input style="padding-left: 10px" id="username" type="text" name="username" class="validate" autocomplete="off" required >
<label style="padding-left: 10px" for="email">Email</label>
</div>

<div class="input-field col s12">
<input style="padding-left: 10px" id="password" type="password" class="validate" name="password" autocomplete="off" required>
<label style="padding-left: 10px" for="password">Password</label>
</div>
<div class="col s12 left-align m-t-sm">
<a style="font-size: 12px" href="signup.php" class="color:orange">Buat akun disini</a>/
<a href="forgot-password.php" class="color:orange" style="font-size: 12px">Lupa password?</a><br>

<input style="width: 75%" type="submit" name="signin" value="Masuk ke dashboard" class="waves-effect waves-light btn blue-grey dark-1">
</div>
</form>
</div>
</div>
