                    ...
                    <div class="col s12 m12 l4">
                        <div class="card stats-card">
                            <div class="card-content">
                                ...
                                <span class="card-title">Pemohon WP</span>
...
?>
                        ...
                        <div class="card stats-card">
                            <div class="card-content">
                                ...
                                <span class="card-title">Konstruksi terjadwal</span>
    <?php
...
?>                            
                    ...
                    <div class="col s12 m12 l4">
                        <div class="card stats-card">
                            <div class="card-content">
                                <span class="card-title">Approval Type</span>
                                    <?php
                        ...
                        <div class="col s12 m12 l12">
                            <div class="card invoices-card">
                                <div class="card-content">
                                    ...
                                    <span class="card-title">Latest Approval WP Applications</span>
