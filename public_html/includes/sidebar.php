...
{               ?>
  ...
  <li class="no-padding"><a class="waves-effect waves-grey" href="emp-changepassword.php"><i class="material-icons">settings_input_svideo</i>Change Password</a></li>
                    <li class="no-padding">
                        <a class="collapsible-header waves-effect waves-grey"><i class="material-icons">apps</i>Working permit<i class="nav-drop-icon material-icons">keyboard_arrow_right</i></a>
                        <div class="collapsible-body">
                            <ul>
                                <li><a href="apply-leave.php">ajukan approval</a></li>
                                <li><a href="leavehistory.php">approval History</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="no-padding">
                        ...
                        <div class="collapsible-body">
                            <ul>
                                 <li>
                                    <a class="waves-effect waves-grey" " href="statuswp.php">Formulir WP Aproval</a>
                                </li> 
                            </ul>
                        </div>
                    </li>
